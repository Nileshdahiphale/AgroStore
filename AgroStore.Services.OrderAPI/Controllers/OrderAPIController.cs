...
using AgroStore.Services.OrderAPI.RabbmitMQSender;

namespace AgroStore.Services.OrderAPI.Controllers
{
    [Route("api/order")]
    [ApiController]
    public class OrderAPIController : ControllerBase
    {
        ...
        public ResponseDto? Get(string? userId = "")
        {
            try
            {
                ...
                {
                    objList = _db.OrderHeaders.Include(u => u.OrderDetails).Where(u => u.OrderDetails.Any(od => od.ProviderId == userId)).ToList();
