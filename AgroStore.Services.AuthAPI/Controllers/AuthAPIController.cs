...
using AgroStore.Services.AuthAPI.Models.Dto;
using AgroStore.Services.AuthAPI.RabbmitMQSender;
using AgroStore.Services.AuthAPI.Service.IService;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace AgroStore.Services.AuthAPI.Controllers
{
    [Route("api/auth")]
    [ApiController]
