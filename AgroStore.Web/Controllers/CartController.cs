    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(CartDto cartDto)
        {
            ...
            if (response != null && response.IsSuccess)
            {
                ...
                {
                    ApprovedUrl = domain + "cart/Confirmation?orderId=" + orderHeaderDto.OrderHeaderId + "&cartId=" + cart.CartHeader.CartHeaderId,
        ...
        public async Task<IActionResult> Confirmation(int orderId, int cartId)
        {
            ResponseDto? response = await _orderService.ValidateStripeSession(orderId);
            if (response != null & response.IsSuccess)
            {
                // cart should be empty here
                _cartService.EmptyCartAsync(cartId);
